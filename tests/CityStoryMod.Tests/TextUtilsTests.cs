...
namespace CityStoryMod.Tests
{
    public class TextUtilsTests
    {
        ...
        public class GetFrontmatterFieldList
        {
            [Fact]
            public void splits_comma_separated_entries()
            {
                string md = "---\nhide_when_exists: a.md, b.md, c.md\n---\n";
                TextUtils.GetFrontmatterFieldList(md, "hide_when_exists")
                    .Should().Equal("a.md", "b.md", "c.md");
            }

            [Fact]
            public void trims_whitespace_around_entries()
            {
                string md = "---\nhide_when_exists:   a.md  ,b.md ,c.md\n---\n";
                TextUtils.GetFrontmatterFieldList(md, "hide_when_exists")
                    .Should().Equal("a.md", "b.md", "c.md");
            ...
            [Fact]
            public void drops_empty_entries()
            {
            ...
            [Fact]
            public void returns_single_entry_when_no_comma()
            {
                string md = "---\nhide_when_exists: only.md\n---\n";
                TextUtils.GetFrontmatterFieldList(md, "hide_when_exists")
                    .Should().Equal("only.md");
            }

            [Fact]
            public void returns_empty_array_when_key_missing()
            {
                string md = "---\nother: x\n---\n";
                TextUtils.GetFrontmatterFieldList(md, "hide_when_exists")
                    .Should().BeEmpty();
            ...
            [Fact]
            public void returns_empty_array_when_value_is_empty()
            {
                string md = "---\nhide_when_exists:\n---\n";
                TextUtils.GetFrontmatterFieldList(md, "hide_when_exists")
                    .Should().BeEmpty();
            ...
            [Fact]
            public void returns_empty_array_for_null_or_empty_content()
            {
                TextUtils.GetFrontmatterFieldList(null, "key").Should().BeEmpty();
                TextUtils.GetFrontmatterFieldList("", "key").Should().BeEmpty();
            }
        }
    }
}
